...
### Os parâmetros do token são explicados na seção 2.2.
...
|16|Não abriu (|
|17|Falto fazer uma declaração de variável|
|18|Não fechou )|
|19|Falta a palvra reservada write|
|20|Falto o símbolo de atribuição :=|
